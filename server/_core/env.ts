export const ENV = {
  ...
  onboardingSlackWebhookUrl: process.env.ONBOARDING_SLACK_WEBHOOK_URL ?? "",
  onboardingSlackBotToken: process.env.WAND_ONBOARDING_BOT_TOKEN ?? "",
  onboardingSlackChannelId: process.env.ONBOARDING_SLACK_CHANNEL_ID ?? "",
};
